        ...
        $.each(Object.keys(dicElementInList), function (i, element) {
            ...
            if (typeof (pipeCI) === 'undefined' || typeof (pipeCI.name) === 'undefined' || typeof (pipeInfoCI['health']) == 'undefined') { //for defects
                ...
                cardHtml += '<li class="list-group-item">' +
                    ...
                    '<br><span class="badge badge-light  pull-left">Last Seccess: </span><span class="badge badge-light pull-right">' + pipeInfoCI['lastSuccessfulBuild'] + '</span>' +
...
function insertCardChart2Datasets(target, labelsArray, dataArray1, dataArray2, dataLabel, title, subtitle) {
    var rndID = 'widgetChart' + Math.floor(Math.random() * 1000) + 1; 
    ...
    $('#' + target).append(cardHtml);
    insertChart2Datasets(rndID, labelsArray, dataArray1, dataArray2, dataLabel);
}
...
function insertChart2Datasets(target, labelsArray, dataArray1, dataArray2, dataLabel) {
    var chartDatasets = [{ type: 'line', data: dataArray1, label: dataLabel, backgroundColor: 'rrgba(131, 201, 143, 1)', borderColor: 'black', yAxisID: 'left-y-axis' },
        { type: 'line', data: dataArray2, label: dataLabel, backgroundColor: 'rgba(255,255,255,.3)', borderColor: 'blue', yAxisID: 'right-y-axis' }];
...
function insertChart(target, labelsArray, chartDatasets, dataLabel) {
